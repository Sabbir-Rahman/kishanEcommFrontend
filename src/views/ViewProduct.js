          ...
          <Card.Body>
            <Row>
              ...
              <Col md='6'>
                <table>
                  <th>
                    <h3 style={{ marginRight: '50px' }}>পণ্যের নাম</h3>
                  </th>
                ...
                <table>
                  ...
                  <th>
                    <h5 style={{ marginRight: '30px', font: 'status-bar' }}>
                      উপজেলাঃ সাতক্ষীরা সদর
                    </h5>
                  </th>
                </table>
                <p>
                  টমেটো একটি সুস্বাদু ও পুষ্টিকর সবজি। টমেটো শীতকালীন সবজি হলেও
                  এখন সারা বছর পাওয়া যায়। কাঁচা কিংবা পাকা দু'ভাবে টমেটো খাওয়া
                  যায়। শুধু খাবারে স্বাদই বাড়ায় না, টমেটো থেকে তৈরি হয় নানা
                  রকমের কেচাপ, সস।
                </p>
                <table>
                  <th>
